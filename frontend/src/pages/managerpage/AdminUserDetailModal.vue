<template>
    <div class="modal fade" :id="'userDetailModal' + info.mid" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" :aria-labelledby="'userDetailModal' + info.mid + 'Label'" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex flex-column gap-3">
                    ...
                    <form class="form-floating">
                        <input class="form-control" type="text" id="username" :placeholder="info.id" v-model="info.id" required />
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" @click="modifyUser">정보 수정</button>
                    <button type="button" class="btn btn-danger" @click="DeleteUser">회원 삭제</button>
...
<script setup>
    ...
    function DeleteUser() {
        ...
        axios.post(store.state.axiosLinkAdmin + "/api/admin/usermanagement/delete", props.info, { headers }).then(function (res) {res.data == true?router.go(0):alert("업데이트실패")});
    }
</script>
<style lang="sass">
    label
