  ...
  <div class="pt-3 pb-3">
    <nav class="navbar navbar-expand-lg d-flex justify-content-between container">
      ...
      <ul class="navbar-nav d-flex justify-content-between">
        <li v-if="!me" class="nav-item active d-flex align-items-center flex-wrap">
        ...
        <li v-else class="nav-item active d-flex justify-content-between align-items-center">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <input type="text" class="form-control serviceSearch mr-2" ref="navInput" v-model="state.navInput"
            ...
            <div class="position-absolute menu-box">
              <div class="pl-2 pr-2 pt-3 pb-3 d-flex flex-column gap-3">
                ...
                <div class="d-flex flex-column ml-2">
                  ...
                  <router-link class="menu-hover menu-btn nav-link" :to="{ name: 'EditTag' }">관심있는 다이어리</router-link>
                  ...
                  <button @click="onLogout" class="d-flex menu-hover menu-btn nav-link">
                    <div>로그아웃</div>
                  </button>
                </div>
              </div>
