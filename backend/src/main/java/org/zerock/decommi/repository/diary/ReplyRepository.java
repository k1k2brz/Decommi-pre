...
public interface ReplyRepository extends JpaRepository<Reply, Long> {
    ...
    @Query("select r from Reply r where diary_dino =:dino order by reply_order asc, reply_group asc, reply_depth desc ")
    ...
    // @Query("select replyGroup from Reply where diary_dino=:dino ORDER BY
    // reply_group desc ")
